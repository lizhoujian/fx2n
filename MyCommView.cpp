...
BEGIN_MESSAGE_MAP(CMyCommView, CFormView)
    ...
    ON_BN_CLICKED(IDC_BTFXTEST, OnBnClickedBtfxtest)
    //}}AFX_MSG_MAP
END_MESSAGE_MAP()
        ...
        << ( pane(VERTICAL,ABSOLUTE_VERT)
                       ...
                       //option
                        <<(pane(HORIZONTAL, ABSOLUTE_VERT)
                            ...
                            << item(IDC_BTFXTEST, NORESIZE)   // send button fxText ALIGN_RIGHT    
...
static CMyCommView *currView = NULL;
static CMyCommDoc *currDoc = NULL;
